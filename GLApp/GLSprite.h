...
public:
  ...
  void UpdateSprite(const intx1,const inty1,const intx2,const inty2);
  void UpdateSprite(const intx1,const inty1,const intx2,
	  const inty2,const float &mx1,const float &my1,const float &mx2,const float &my2);
  ...
  void Render(const booldoLinear);
