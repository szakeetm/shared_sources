...
public:
  ...
  static void SetViewport(const intx,const inty,const intwidth,const intheight);
  ...
  // Drawing functions
  static void DrawBox(const intx,const inty,const intwidth,const intheight,
	  const intr,const intg,const intb,const boolshadow=false,const booliShadow=false,
	  const boolisEtched=false);
  static void DrawBorder(const intx,const inty,const intwidth,const intheight,
	  const boolshadow,const booliShadow,const boolisEtched);
  ...
  static void DrawButtonBack(const intx,const inty,const intwidth,
	  const intheight,const intstate);
  ...
  static void DrawTextBack(const intx,const inty,const intwidth,
	  const intheight,const intrBack,const intgBack,const intbBack);
  ...
  // Initialisation
  static bool RestoreDeviceObjects(const intwidth,const intheight);
