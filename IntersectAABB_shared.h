...
void IntersectTree(MFSim::ParticleTracer &currentParticleTracer, const AABBNODE &node, const Vector3d &rayPos,
                   const Vector3d &rayDirOpposite, SimulationFacet *const lastHitBefore, const boolnullRx,
                   const boolnullRy, const boolnullRz, const Vector3d &inverseRayDir, bool &found,
...
bool IsInFacet(const SimulationFacet &f, const doubleu, const doublev);
