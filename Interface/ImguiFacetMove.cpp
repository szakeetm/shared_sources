...
bool BaseVertexSelectButton(InterfaceGeometry* interfGeom) {
    ...
    {
        Popup("Select exactly one vertex");
        return false;
    }
    else
    {
...
bool BaseFacetSelectButton(InterfaceGeometry* interfGeom) {
    ...
    if (selFacets.size() != 1) {
        Popup("Select exactly one facet");
        return false;
    }
