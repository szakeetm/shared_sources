...
static const int appVersionId = 2673; //Compared with available updates. Global variable, so rebuild whole solution if changed.
static const std::string appVersionName = "2.6.73";
//---------------------------------------------------
#ifdef _DEBUG
